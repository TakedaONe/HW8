...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(2000, 50, "Zeus");
        Warrior warrior1 = new Warrior(270, 20, "Hercules");
        Warrior warrior2 = new Warrior(280, 15, "Achilles");
        Magic magic = new Magic(260, 20, "Merlin", 5); // Example attack increase
        ...
        Hacker hacker = new Hacker(240, 15, "Hacker", 30); // Example health steal
